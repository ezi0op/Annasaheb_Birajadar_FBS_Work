...
abstract class InsurancePreCal {
	...
	void policyDetails() {
		System.out.println("Insurance Holder Name is " + this.pHolderName);
		System.out.println("Base Premium is " + this.basePremium);
		System.out.println("Final Premium is " + calculatePremium());
	}
...
class TestIns {
	public static void main(String[] args) {
		...
		if (choice == 1) {
			...
			HealthInsurance b = new HealthInsurance(name, base, age, smoker, disease);
			b.policyDetails();
		} else {
