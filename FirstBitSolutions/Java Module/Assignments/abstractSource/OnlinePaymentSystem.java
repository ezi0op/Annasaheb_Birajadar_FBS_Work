...
abstract class OnlinePaymentSystem {
	...
	OnlinePaymentSystem(int pId, double amount, String pName, String status) {
		this.pId = pId;
		this.amount = amount;
		this.pName = pName;
		this.status = status;
...
class CardPayment extends OnlinePaymentSystem {
	...
	CardPayment(int pId, double amount, String pName, String status, String cardNumber, String cvv) {
		super(pId, amount, pName, status);
...
class UpiPayment extends OnlinePaymentSystem {
	...
	UpiPayment(int pId, double amount, String pName, String status, String upiId) {
		super(pId, amount, pName, status);
		this.upiId = upiId;
	}// Parameterized Constructor
...
class TestOPS {
	public static void main(String[] args) {
		...
		a1 = new CardPayment(101, 128, "asd", "Success", "1234567812345678", "137");
		a1.process();
		System.out.println(a1);
		System.out.println("\n\n");
		a1 = new CardPayment(101, 0, "asd", "Success", "1234567812345678", "137");
		a1.process();
		System.out.println(a1);
		System.out.println("\n\n");
		a1 = new UpiPayment(101, 0, "asd", "Success", "1234567812345678");
		a1.process();
		System.out.println(a1);
	}
}
