...
class Defence {
	...
	public String toString() {
		return "Head Of Name is :" + this.headOfName + "\nNo of troops :" + this.noOfTroops + "\nBudget is :"
				+ this.budget + "\nNo of departemt :" + this.noOfDepartment + "\nNo of vehicle is :" + this.noOfVehicle
				+ "\nlocation of headQuarter :" + this.locationOfHeadQuarter + "\nCountry Name is :" + this.countryName
				+ "\nMan power count is :" + this.manPowerCount + "\nNo of casulties is :" + this.noOfCasulties
				+ "\nNo of Mission Performed :" + this.noOfMissionPerformed + "\nNo fo bases  is :" + this.noOfBases;
	}
//
//	void display() {
...
class Army extends Defence {
	...
	Army(String headOfName, int noOfTroops, double budget, int noOfDepartment, int noOfVehicle,
		...
		super(headOfName, noOfTroops, budget, noOfDepartment, noOfVehicle, locationOfHeadQuarter, countryName,
				manPowerCount, noOfCasulties, noOfMissionPerformed, noOfBases);
	...
	void attack() {
		System.out.println("Attacked by tank");
		System.out.println("Attacked by gun");
		System.out.println("Attacked by granades");
		System.out.println("Attacked by batalien");

	}

	@Override
	public String toString() {
		return super.toString() + "\nNo OF Tank is " + this.noOfTank + "\nNo OF Guns is " + this.noOfGuns
				+ "\nNo OF Granades is " + this.noOfGranades + "\nNo OF Batalien is " + this.noOfBatalien;
	}
//
//	void display() {
//		super.display();
...
class Navy extends Defence {
	...
	void attack() {
		System.out.println("Attacked by ships");
		System.out.println("Attacked by Submeriens");
		System.out.println("Attacked by Torpedeos");

	}

	@Override
	public String toString() {
		return super.toString() + "\nNo OF ships is " + this.noOfShips + "\nNo OF Submerines is " + this.noOfSubmariens
				+ "\nNo OF Torpedos is " + this.noOfTorpedos;
	}
//
//	void display() {
//		super.display();
...
class Air extends Defence {
	...
	void attack() {
		System.out.println("Attacked by missiles");
		System.out.println("Attacked by Aircrafts");
		System.out.println("Attacked by Squatron");

	}
	@Override
	public String toString() {
		return super.toString() + "\nNo OF Missiles is " + this.noOfMissiles + "\nNo OF Aircrafts is " + this.noOfAircrafts
				+ "\nNo OF  is Squafron is" + this.noOfSquadron;
	}
...
//		System.out.println("No of Squardon :" + this.noOfSquadron);
//	}
