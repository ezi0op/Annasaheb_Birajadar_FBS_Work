...
class Artist {
	...
	void display() {
		...
		System.out.println("Experience is " + this.experience + " years");
...
class Singer extends Artist {
	...
	Singer(String name, String genre, int experience, String country, int awards, int age, int songRecorded,
			String voiceType, String famousSong, int albumCount) {
...
class Musician extends Artist {
	...
	Musician(String name, String genre, int experience, String country, int awards, int age, String instrument,
			int albumsComposed, String bandName, double studioHours) {
		super(name, genre, experience, country, awards, age);
