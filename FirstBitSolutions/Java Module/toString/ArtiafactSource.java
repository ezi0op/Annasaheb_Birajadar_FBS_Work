...
class Artifact {
	...
	void preserve() {
		System.out.println("Preserve the artifact to maintain its condition and prevent damage");
	}
	
	
	@Override
	public String toString() {
		return "Artifact ID: " + this.artifactId+"\nName: " + this.name+"\nOrigin Country: " + this.originCountry+"\nYear: " + this.year;
	}
//
//	void display() {
...
class Painting extends Artifact {
	...
	void preserve() {
		System.out.println("Controlled temperature, humidity");
	}
...
class Sculpture extends Artifact {
	...
	void preserve() {
		System.out.println("Regular cleaning, structural support");
	}
...
class Coin extends Artifact {
	...
	void preserve() {
		System.out.println("Preserve the coin by storing it in a protective case, avoiding direct handling, and keeping it in a dry environment");
	}


	@Override
	public String toString() {
		return super.toString()+ "Metal Type : " + this.metalType+"\nDenomination : " + this.denomination+"\nEra :" + this.era;
			}
